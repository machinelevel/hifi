...
public:
    ...
    const std::vector<glm::vec3>& getHandPositions() const { return _handPositons; }
    ...
    void setHandPositions(const std::vector<glm::vec3>& handPositons) { _handPositons = handPositons; }
...
protected:
    ...
    std::vector<glm::vec3> _handPositons;
